...
async function configureSpendingRules(eoa, kitepassAddress, signFunction) {
    ...
    try {
        ...
        const rulesToAdd = [
            {
                timeWindow: 86400n, // 24 hours in seconds
                budget: ethers_1.ethers.parseUnits('100', 18), // 100 tokens
                initialWindowStartTime: todayStartTimestamp, // start from today's 00:00:00
                targetProviders: [] // Empty means applies to all providers
            },
            {
                timeWindow: 604800n, // 1 week in seconds
                budget: ethers_1.ethers.parseUnits('1000', 18), // 1000 tokens per week
                initialWindowStartTime: currentWeekStartTimestamp, // start from current week's monday 00:00:00
                targetProviders: []
            },
            {
                timeWindow: 0, // for every transaction
                budget: ethers_1.ethers.parseUnits('10', 18), // 10 tokens per transaction
